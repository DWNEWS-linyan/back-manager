var PerSonInfo = function(){
	...
	var personInfoValidate = function(){
		var personInfoForm = $("#person-info-form-id");
		var personInfoFormValidate = personInfoForm.validate({
//			errorElement: 'span',
...
//                }
	        ...
	        submitHandler: function(form) {
	        	...
	        	var ctx = App.domain();
	        	var fgg = document.querySelector("#person-info-form-id");
...
//	            form.submit(); // form validation success, call ajax form submit
		...
		$(".date-picker").each(function(){
			$(this).find("input").change(function(){
				personInfoValidate.element(this);
			});
		});
		
	};
	var personPassValidate = function(){
		var personPassForm = $("#person-pass-form-id");
		var personPassFormValidate = personPassForm.validate({
//			errorElement: 'span',
//			errorClass: 'help-block',
			errorElement: 'span', //default input error message container
            errorClass: 'help-block help-block-error', // default input error message class
...
//                }
	        ...
	        submitHandler: function(form) {
	        	App.blockUI({"zIndex":1000});
	        	var ctx = App.domain();
	        	var fgg = document.querySelector("#person-pass-form-id");
				var data = new FormData(fgg);
				console.info(data);
				$.ajax({
					url:App.domain()+"/system/updateSysUserPass",
					data:data,
					contentType: false,
	                processData: false,
	                type:"post",
